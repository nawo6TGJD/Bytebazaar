...
public class OrderController {
    ...
    private String sendVerificationEmail(Order order)
        ...
        helper.setFrom("senderemail@gmail.com", senderName);
        if (order.getUser() != null && order.getUser().getEmail() != null) {
            helper.setTo(order.getUser().getEmail());
        } else {
            // Set default email address
            String defaultEmail = "receiveremail@gmail.com";
            helper.setTo(defaultEmail);
        }
        helper.setSubject(subject);
        helper.setText(mailContent, true);

        ClassPathResource pathResource = new ClassPathResource("/static/assets/GadgetGlare.png");
